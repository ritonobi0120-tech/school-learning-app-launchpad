(function (root) {
  ...
  const STAGE_PLANS = {
    'round-digit': withLevels([
      ...
      { place: 'thousands', kept: 6, tail: 499 },
      { place: 'thousands', kept: 6, tail: 500 },
      { place: 'hundreds', kept: 76, tail: 99 },
      { place: 'thousands', kept: 7, tail: 999 },
      { place: 'ones', kept: 1203, tail: 0 },
      { place: 'tens', kept: 407, tail: 6 },
      { place: 'hundreds', kept: 92, tail: 5 },
      { place: 'thousands', kept: 1, tail: 67 },
      { place: 'hundreds', kept: 65, tail: 56 },
      { place: 'hundreds', kept: 82, tail: 1 },
      { place: 'hundreds', kept: 91, tail: 1 },
      { place: 'tens', kept: 612, tail: 0 },
      { place: 'hundreds', kept: 84, tail: 87 },
      { place: 'thousands', kept: 3, tail: 999 },
    ]),
