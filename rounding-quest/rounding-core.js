(function (root) {
  ...
  const STAGE_PLANS = {
    'round-digit': withLevels([
      ...
      { place: 'ones', kept: 12345, tail: 0 },
      { place: 'ones', kept: 23456, tail: 0 },
      { place: 'tens', kept: 3456, tail: 0 },
      { place: 'tens', kept: 4567, tail: 0 },
      { place: 'hundreds', kept: 567, tail: 20 },
      { place: 'hundreds', kept: 678, tail: 90 },
      { place: 'tens', kept: 7890, tail: 0 },
      { place: 'hundreds', kept: 890, tail: 0 },
      { place: 'hundreds', kept: 1234, tail: 20 },
      { place: 'hundreds', kept: 2345, tail: 30 },
    ]),
    'round-place': withLevels([
      ...
      { place: 'hundreds', kept: 1234, tail: 0 },
      { place: 'hundreds', kept: 2345, tail: 0 },
      { place: 'thousands', kept: 345, tail: 0 },
      { place: 'thousands', kept: 456, tail: 0 },
      { place: 'thousands', kept: 567, tail: 0 },
      { place: 'thousands', kept: 678, tail: 0 },
      { place: 'thousands', kept: 789, tail: 0 },
      { place: 'thousands', kept: 890, tail: 0 },
      { place: 'tenThousands', kept: 123, tail: 0 },
      { place: 'tenThousands', kept: 234, tail: 0 },
    ]),
    significant: withLevels([
      ...
      { digits: 2, totalDigits: 6, kept: 12, tail: 0 },
      { digits: 2, totalDigits: 6, kept: 13, tail: 0 },
      { digits: 2, totalDigits: 6, kept: 24, tail: 0 },
      { digits: 2, totalDigits: 6, kept: 25, tail: 0 },
      { digits: 2, totalDigits: 6, kept: 36, tail: 0 },
      { digits: 3, totalDigits: 6, kept: 123, tail: 0 },
      { digits: 3, totalDigits: 6, kept: 205, tail: 0 },
      { digits: 3, totalDigits: 6, kept: 314, tail: 0 },
      { digits: 3, totalDigits: 7, kept: 426, tail: 0 },
      { digits: 3, totalDigits: 7, kept: 537, tail: 0 },
    ]),
    'final-mix': withLevels([
      ...
      { type: 'significant', digits: 2, totalDigits: 6, kept: 24, tail: 0 },
      { type: 'round-digit', place: 'ones', kept: 12345, tail: 0 },
      { type: 'round-place', place: 'hundreds', kept: 2345, tail: 0 },
      { type: 'significant', digits: 2, totalDigits: 6, kept: 38, tail: 0 },
      { type: 'round-digit', place: 'tens', kept: 4567, tail: 0 },
      { type: 'round-place', place: 'thousands', kept: 678, tail: 0 },
      { type: 'significant', digits: 3, totalDigits: 6, kept: 205, tail: 0 },
      { type: 'round-digit', place: 'hundreds', kept: 890, tail: 0 },
      { type: 'round-place', place: 'tenThousands', kept: 123, tail: 0 },
  ...
  function finalMixPrompt(question, plan, index) {
    const contexts = {
      'round-digit': [
        (q, p) => `記録は${formatNumber(q.value)}点です。${PLACE_BY_KEY[p.place].label}で四捨五入した数を答えましょう。`,
        (q, p) => `番号は${formatNumber(q.value)}番です。${PLACE_BY_KEY[p.place].label}で四捨五入した数を答えましょう。`,
